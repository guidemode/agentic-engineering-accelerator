...
The core delivery is 12 weeks. Many enterprise engagements run this as a **14-week envelope**: 2 weeks for mobilisation and business-case setup, then the 12-week accelerator.

This is **v0**. Expect it to change as we run it.

## Shape

Six 2-week phases. Each phase has an objective, the work, a stage gate, and what it contributes to the shared marketplace.

| Phase | Weeks | Focus | Doc |
|---|---|---|---|
| 0 | 1-2 | Leadership bootcamp + baseline + business case setup | [phase-0-leadership-bootcamp.md](phase-0-leadership-bootcamp.md) |
| 1 | 3-4 | Guardrails and context reverse-engineering | [phase-1-guardrails.md](phase-1-guardrails.md) |
| 2 | 5-6 | First supervised features | [phase-2-first-features.md](phase-2-first-features.md) |
| 3 | 7-8 | Workflow scale-up | [phase-3-scale-up.md](phase-3-scale-up.md) |
| 4 | 9-10 | Full agentic patterns | [phase-4-full-agentic.md](phase-4-full-agentic.md) |
| 5 | 11-12 | Graduation and recommendation | [phase-5-rollout.md](phase-5-rollout.md) |
...
**Optional fourth track - legacy rewrite via bounded autonomous loops.** Decision is deferred to the end of Phase 2 / start of Phase 3, once foundational patterns are proven.

**The pilot stays bounded.** No new teams are added during the program. In Phase 3 we add 1-2 new engineers to each lighthouse team to test transferability at the individual level. The decision to scale to additional teams happens after the program, as an output of Phase 5.

### The Agentic Engineer role

The program is delivered by **about 2 senior engineers in an Agentic Engineer role**. They are embedded with the lighthouse teams across all 12 weeks, splitting time across the three teams plus marketplace and communications work.
...
- **Mid-program checkpoint** (around end of Phase 3): broader update for leadership and adjacent teams, including early cost baseline
- **Final summary** at end of Phase 5: public-facing version of the recommendation for the wider engineering organisation
- **Channel and format agreed in Phase 0** so people know where to look every time

### FinOps

Token usage and cost forecasting become first-class from Phase 3 onwards. Baseline in Phase 3, operating discipline in Phase 4, formal review and forecast in Phase 5.

### Metrics and telemetry

Baseline is captured in **Phase 0** and tracked to Phase 5. See [Measurement](#measurement).
...
Baselined in Phase 0 and tracked weekly through Phase 5. Keep the basket small and practical.
...
| Archetype | Best for early phases | Risk profile | Phase 4 ambition |
|---|---|---|---|
...
| Legacy rewrite (optional) | Starts Phase 3 at earliest | Highest | Bounded autonomous loops against clear specs and tests |

## Security, compliance, legal

Assumed cleared at kickoff. **A formal review is scheduled in Phase 5** before any broader rollout, covering code provenance, data egress, autonomous-action audit trails, and any production-touching flows.
...
- Engineers added in Phase 3 have written onboarding feedback as transferability evidence
...
- Phase 2 PR targets and stop-the-line triggers (Phase 0 deliverable)
- Legacy rewrite track yes/no (end of Phase 2)
- Steady-state operating model recommendation (Phase 5 deliverable)
